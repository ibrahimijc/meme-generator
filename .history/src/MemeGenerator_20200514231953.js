...
class MemeGenerator extends Component{
    ...
    render(){
        ...
        return <option memeid={meme.id} value={meme.url}>{meme.name}</option>
        })
       ...
       return ( <div>
        ...
        <button type="button" onClick={this.generateRandom}>Random</button>
        <p>    </p> <hr></hr>
        <button  disabled={!this.state.toptext || !this.state.bottomtext} type="button" onClick={this.handleSubmit}>Caption</button>
